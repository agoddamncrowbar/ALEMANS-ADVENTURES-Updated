...
import { ugandaNationalParksData } from "./NationalParksInfo";
import { ugandaPopularParksData } from "./PopularParksInfo";
import { ugandaConservanciesData } from "./ConservanciesInfo";
...
export default function UgandaNationalParks() {
  ...
  const data =
    category === "national"
      ? ugandaNationalParksData
      : category === "popular"
      ? ugandaPopularParksData
      : ugandaConservanciesData;
